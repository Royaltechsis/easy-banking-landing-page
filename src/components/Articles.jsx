        ...
        return (
            <div className="item flex flex-col sm:w-1/4 w-4/5 p-4">
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <h6 className="text-gray-500">{author}</h6>
                    <h3 className="text-lg text-primary-DarkBlue">{title}</h3>
    ...
    return (
        <div className="container flex items-center justify-center">
            <div className="inner-container w-10/12 gap-20 flex flex-col p-5">
                ...
                <div className="items-list sm:flex sm:gap-3 sm:flex-row flex-wrap sm:justify-between justify-center items-center flex flex-col">
